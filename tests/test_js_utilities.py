...
def test_js_cyberspark_utilities():
    """Runs the JavaScript Node.js unit tests for cyberspark.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cyberspark.test.js")
...
def test_js_cybervoid_utilities():
    """Runs the JavaScript Node.js unit tests for cybervoid.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cybervoid.test.js")
    ...
    assert result.returncode == 0, f"JS test cybervoid.test.js failed with code {result.returncode}"


def test_js_cybermirage_utilities():
    """Runs the JavaScript Node.js unit tests for cybermirage.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cybermirage.test.js")
    ...
    assert result.returncode == 0, f"JS test cybermirage.test.js failed with code {result.returncode}"


def test_js_cyberbastion_utilities():
    """Runs the JavaScript Node.js unit tests for cyberbastion.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cyberbastion.test.js")
    ...
    assert result.returncode == 0, f"JS test cyberbastion.test.js failed with code {result.returncode}"


def test_js_cybervalkyrie_utilities():
    """Runs the JavaScript Node.js unit tests for cybervalkyrie.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cybervalkyrie.test.js")
    ...
    assert result.returncode == 0, f"JS test cybervalkyrie.test.js failed with code {result.returncode}"


def test_js_cyberphoenix_utilities():
    """Runs the JavaScript Node.js unit tests for cyberphoenix.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cyberphoenix.test.js")
    ...
    assert result.returncode == 0, f"JS test cyberphoenix.test.js failed with code {result.returncode}"
