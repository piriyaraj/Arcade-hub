...
def test_js_cyberblitz_utilities():
    """Runs the JavaScript Node.js unit tests for cyberblitz.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cyberblitz.test.js")
    ...
    assert result.returncode == 0, f"JS test cyberblitz.test.js failed with code {result.returncode}"
