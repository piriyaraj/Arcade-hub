...
def test_js_cyberastral_utilities():
    """Runs the JavaScript Node.js unit tests for cyberastral.test.js and asserts success."""
    tests_dir = os.path.dirname(os.path.abspath(__file__))
    test_file = os.path.join(tests_dir, "cyberastral.test.js")
    ...
    assert result.returncode == 0, f"JS test cyberastral.test.js failed with code {result.returncode}"
