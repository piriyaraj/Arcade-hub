...
test('Leaderboard aggregations', () => {
  ...
  const cyberQuasarScore = scores.find(s => s.id === 'cyberquasar');
  ...
  assert.strictEqual(cyberQuasarScore.score, 10600);
  ...
  assert.strictEqual(mockStorage['cyberquasar_best'], undefined);
});
