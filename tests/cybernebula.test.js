...
test('CyberNebulaEngine - Start game & enemy spawning', () => {
  const canvas = createMockCanvas();
  const engine = new CyberNebulaEngine(canvas);
...
test('CyberNebulaEngine - EMP Nova trigger', () => {
  const canvas = createMockCanvas();
  const engine = new CyberNebulaEngine(canvas);
  engine.start();
...
test('CyberNebulaEngine - Starlight Shield activation', () => {
  const canvas = createMockCanvas();
  const engine = new CyberNebulaEngine(canvas);
  engine.start();
...
test('CyberNebulaEngine - Shooting stardust beams & position update', () => {
  const canvas = createMockCanvas();
  const engine = new CyberNebulaEngine(canvas);
  engine.start();
...
test('CyberNebulaEngine - Game pause & resume toggle', () => {
  const canvas = createMockCanvas();
  const engine = new CyberNebulaEngine(canvas);
  engine.start();
...
test('CyberNebulaEngine - Game Over and high score update', () => {
  const canvas = createMockCanvas();
  const engine = new CyberNebulaEngine(canvas);
  engine.start();
